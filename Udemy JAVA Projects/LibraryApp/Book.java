public class Book {
    ...
    //generate auto by click right, source action, generate constructor
    ...
    public Book(String isbn, String title, String genre, String description, String author, int quantity,
            int numCheckedOut) {
        this.isbn = isbn;
        this.title = title;
        this.genre = genre;
